...
class CreateZauthRulesTable extends Migrator
{
    public  function  change()
    {
        ...
        $table->addColumn('url', 'string',array('limit' => 80,'default'=>NULL,'null'=>true,'comment'=>'规则url'))
        ->addColumn('title', 'string',array('limit' => 20,'default'=>NULL,'comment'=>'规则标题')) 
        ->addColumn('type', 'integer',array('limit' => 1,'default'=>1,'comment'=>'规则类型,1导航,2其他如按钮等'))
        ->addColumn('icon', 'string',array('limit' => 32,'default'=>NULL,'comment'=>'图标'))
